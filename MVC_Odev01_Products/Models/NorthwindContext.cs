...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<EmployeeTrigger> EmployeeTriggers { get; set; }
    ...
    public virtual DbSet<UrunKategorileri33> UrunKategorileri33s { get; set; }

    public virtual DbSet<Yazarlar> Yazarlars { get; set; }

    public virtual DbSet<YeniTedarikciler> YeniTedarikcilers { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("server=LAPTOP-TKFJC4RO\\SQLEXPRESS;database=Northwind;Trusted_Connection=true;TrustServerCertificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.ToTable(tb => tb.HasTrigger("UlkeYoksaGuncelle"));
        ...
        modelBuilder.Entity<EmployeeTrigger>(entity =>
        {
            entity.HasKey(e => e.PersonelId);

            entity.ToTable("EmployeeTrigger");
        ...
        modelBuilder.Entity<KitapKategorileri>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("KitapKategorileri");
            ...
            entity.HasOne(d => d.IdNavigation).WithMany()
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_KitapKategorileri_Kategoriler");

            entity.HasOne(d => d.Kategori).WithMany()
                .HasForeignKey(d => d.KategoriId)
                .HasConstraintName("FK_KitapKategorileri_Kitaplar");
        });
        ...
        modelBuilder.Entity<Kitaplar>(entity =>
        {
            ...
            entity.HasOne(d => d.YazarNavigation).WithMany(p => p.Kitaplars)
        ...
        modelBuilder.Entity<OrderDetail>(entity =>
        {
            ...
            entity.ToTable(tb =>
                {
                    tb.HasTrigger("StokMiktariniAzalt");
        ...
        {
            entity.ToTable(tb => tb.HasTrigger("trg_SuppliersChanges"));
        ...
        modelBuilder.Entity<SuppliersTrigger>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("SuppliersTrigger");
            ...
            entity.Property(e => e.IslemTipi).HasMaxLength(15);
            entity.Property(e => e.Phone).HasMaxLength(24);
            entity.Property(e => e.PostalCode).HasMaxLength(10);
            entity.Property(e => e.Region).HasMaxLength(15);
            entity.Property(e => e.SupplierId).HasColumnName("SupplierID");
        ...
        modelBuilder.Entity<Testo>(entity =>
        {
            entity.ToTable("Testo");
        ...
        modelBuilder.Entity<UrunKategorileri33>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("UrunKategorileri33");
        ...
        modelBuilder.Entity<Yazarlar>(entity =>
        {
            ...
            entity.Property(e => e.YazarId).HasColumnName("YazarID");
            entity.Property(e => e.Yazarlar1)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("Yazarlar");
        });

        modelBuilder.Entity<YeniTedarikciler>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("YeniTedarikciler");

            entity.Property(e => e.CompanyName).HasMaxLength(40);
            entity.Property(e => e.Ülke)
                .HasMaxLength(15)
                .HasColumnName("ÜLKE");
        });
